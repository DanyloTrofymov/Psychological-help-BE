  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    try {
      ...
      if (!payload || typeof payload !== "object" || payload.type !== "access") {
        throw new UnauthorizedException({ message: INVALID_TOKEN, statusCode: 401 });
      }
      ...
      throw new UnauthorizedException({ message: INVALID_TOKEN, error: error.message, statusCode: 401 });
    }
  }
